    ...
    <DashboardLayout>
      <div className="space-y-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-valasys-gray-900">Choose your right plan!</h1>
            <p className="text-valasys-gray-600">Select from best plans, ensuring a perfect match.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {sortedPlans.map((p, idx) => (
            <PlanCard key={p.id} plan={p} billing={billing} planIndex={idx as 0 | 1 | 2} selected={p.id === "growth"} />
          ))}
        </div>
        ...
        <Card>
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="text-xs"><Info className="w-3 h-3 mr-1" /> Included features per plan</Badge>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <div className="flex justify-center">
          <Button size="lg" className="bg-valasys-orange text-white hover:bg-valasys-orange/90">
