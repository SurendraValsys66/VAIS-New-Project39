                ...
                <div className="md:text-right">
                  <div className="flex flex-wrap items-center justify-center md:justify-end">
                    ...
                    <div className="mt-3 md:mt-0 md:pl-6 md:border-l border-valasys-gray-200 w-full md:w-auto flex justify-center">
                      <Button onClick={() => setShowSuccess(true)} className="bg-gradient-to-r from-valasys-orange to-valasys-orange-light text-white hover:from-valasys-orange/90 hover:to-valasys-orange-light/90 mx-auto">
