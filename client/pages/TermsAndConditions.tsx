  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-valasys-gray-800 mb-4">
          You must use the service in compliance with applicable laws and our
          acceptable use policies. Accounts may be suspended for abuse or
          security risks.
        </p>
        <h2 className="text-lg font-semibold text-valasys-gray-900 mt-8 mb-2">
        ...
        <p className="text-valasys-gray-800 mb-4">
          Features and credits are provided according to your plan. Pricing and
